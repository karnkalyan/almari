...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="h-[100dvh] bg-slate-50 font-inter flex overflow-hidden w-full relative">
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed lg:static inset-y-0 left-0 w-72 bg-slate-900 text-white z-50 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
           ...
           <div className="flex items-center gap-4 md:gap-8">
              ...
              <div className="flex items-center gap-2 md:gap-4">
                 ...
                 <div className="flex items-center gap-3 pl-2">
                    ...
                    <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-slate-100 to-slate-200 border border-slate-200 flex items-center justify-center font-black text-slate-600 shadow-sm overflow-hidden">
